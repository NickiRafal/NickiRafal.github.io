...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function fetchSudokuBoard() {
        fetch("http://pure-stream-18400-20e1ee0431c7.herokuapp.com/api/sudoku/board")
    ...
    function makeMove(move) {
        fetch("http://pure-stream-18400-20e1ee0431c7.herokuapp.com/api/sudoku/move", {
            method: "POST",
            headers: {
    ...
    function resetBoard() {
        fetch("http://pure-stream-18400-20e1ee0431c7.herokuapp.com/api/sudoku/reset", {
            method: "POST",
    ...
    function checkGameCompleted() {
        fetch("http://pure-stream-18400-20e1ee0431c7.herokuapp.com/api/sudoku/check")
            .then((response) => response.json())
